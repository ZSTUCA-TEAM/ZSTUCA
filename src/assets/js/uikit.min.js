...
!(function (t, e) {
  ...
  function st(t, e) {
    for (var n = 0, i = [e, 'data-' + e]; n < i.length; n++) if (rt(t, i[n])) return it(t, i[n])
  }
  function at(t, e) {
  ...
  function ct(t, e) {
    return void 0 === e && (e = document), mt(t) || C(e) ? e : e.ownerDocument
  }
  function ut(t, e) {
  ...
  function Kt(s, a) {
    return new Rt(function (t, e) {
      ...
      Mt(i, 'load', function () {
        0 === i.status || (200 <= i.status && i.status < 300) || 304 === i.status
          ? t(i)
            ...
            try {
              0 === o.state
                ? I(e)
                  ...
                  : i(o.value)
                : 1 === o.state && (I(n) ? i(n.call(void 0, o.value)) : r(o.value))
            } catch (t) {
              r(t)
            }
          }
  ...
  var Jt = /msie|trident/i.test(window.navigator.userAgent),
    ...
    ee =
      Qt || (window.DocumentTouch && document instanceof DocumentTouch) || navigator.maxTouchPoints,
  ...
  function ue(t, e, n, i) {
    ...
    var r = (e = V(e)).length
    return (
      (t = B(t) ? F(t) : 'next' === t ? n + 1 : 'previous' === t ? n - 1 : ce(e, t)),
  ...
  function $e(t) {
    ...
    return (
      xe.test(t) ? n.insertAdjacentHTML('beforeend', t.trim()) : (n.textContent = t),
        ...
        V(t).forEach(function (t) {
          for (var e = t.classList, n = 0; n < i.length; n++)
            Be.Force
              ...
              : e[(H(r) ? !e.contains(i[n]) : r) ? 'add' : 'remove'](i[n])
        })
    }
  }
  function De(t, n, i) {
    ...
    return (e =
      ...
      (Ve[t] =
        (function (t) {
          ...
          var n,
            i = Ye.length
          for (; i--; ) if ((n = '-' + Ye[i] + '-' + t) in e) return n
        })(t) || t))
  }
        ...
        V(t).map(function (s) {
          return new Rt(function (i, r) {
            if (Me(s, Ke))
              ...
              w(e, Xe) &&
                (a && (t += ' uk-transform-origin-' + a), h && (t += ' ' + Xe + 'reverse')),
                o(),
                Dt(
                  s,
  ...
  function nn(t) {
    ...
    Et(t) ||
      ...
      ((e = it(t, 'style')),
      (n = it(t, 'hidden')),
      it(t, { style: (e || '') + ';display:block !important;', hidden: null }))
  ...
  function $n(t) {
    void 0 === t && (t = !1),
      xn.scheduled || ((xn.scheduled = !0), t ? Rt.resolve().then(kn) : requestAnimationFrame(kn))
  }
  function In(t) {
        ...
        r ||
          (setTimeout(function () {
            ...
            e && 100 < t - i.positions[e - 1].time && i.positions.splice(0, e),
              i.positions.push({ time: t, x: n.pageX, y: n.pageY }),
  ...
  ;(On.prototype.isVideo = function () {
      ...
      return i || r
        ? (this.ready = new Rt(function (t) {
            Dt(e.el, 'load', function () {
              if (i) {
                var t = function () {
                  return zn(e.el, { event: 'listening', id: e.id })
                }
    ...
    (On.prototype.pause = function () {
      ...
      this.isVideo() &&
        (this.isIFrame()
          ? this.enableApi().then(function () {
              return zn(t.el, { func: 'pauseVideo', method: 'pause' })
            })
    ...
    (On.prototype.mute = function () {
      ...
      this.isVideo() &&
        (this.isIFrame()
          ? this.enableApi().then(function () {
              return zn(t.el, { func: 'mute', method: 'setVolume', value: 0 })
            })
  ...
  function Kn(t, e) {
    ...
    for (var s in r) {
      ...
      if (!H(h)) {
        if (
          ((h = (r[s] === Boolean && '' === h) || Qn(r[s], h)), 'target' === a && (!h || w(h, '_')))
        )
          continue
        n[s] = h
      }
    ...
    ;(r = I(r) ? r.call(e) : r || e.$el),
      $(r)
        ...
        : !r ||
          ...
          e._events.push(
            Mt(r, t, h ? (D(h) ? h : h.call(e)) : null, o, O(a) ? { passive: a, capture: s } : s)
          ))
  }
  function Zn(t, e) {
  ...
  ;(Hn.util = Object.freeze({
    ...
    (Ln.extend = function (t) {
      ...
      return (
        (t = t || {}),
        (((e.prototype = Object.create(this.prototype)).constructor = e).options = Nn(
          this.options,
          t
        )),
        (e.super = this),
      ...
      ;(i.prototype.$mount = function (t) {
        ...
        (i.prototype.$destroy = function (t) {
          ...
          n && this._callDisconnected(),
            ...
            n && n[r] && (delete n[r][i], P(n[r]) || delete n[r], t && ve(this.$el))
        }),
          ...
          return new Rt(function (t) {
            ...
            if (d.queued && H(l) && H(u) && d.hasAnimation && !(c.length < 2)) {
              var o = document.body,
                ...
                a = i[0],
                h =
                  (Ze.inProgress(a) && Me(a, 'uk-animation-leave')) ||
                  (Ue.inProgress(a) && '0px' === a.style.height)
              ;(n = e(i)),
                h ||
                  (n = n.then(function () {
                    var t = e(r)
                      ...
                      return function (t, e) {
                        ...
                        return (
                          ...
                          (e
                            ...
                            : Ue.start(t, c, Math.round(a * (r / o)), u).then(function () {
                                return l(t, !1)
                              })
                          ).then(function () {
                            return He(t, h)
                      ...
                      return function (t, e) {
                        return (
                          ...
                          e
                            ...
                            : Ze.out(t, n[1] || n[0], i, r).then(function () {
                                return o(t, !1)
                              })
                        )
                      }
        ...
        _toggle: function (t, e) {
          ...
          t &&
            ...
            this.cls
              ...
              : (n = e === rt(t, 'hidden')) && it(t, 'hidden', e ? null : ''),
  ...
  var ni = {
      ...
      methods: {
        toggle: function (r, o) {
          ...
          ;(r = this.items[t]) &&
            [r].concat((!this.multiple && !y(a, r) && a) || []).forEach(function (t) {
              var e = t === r,
                n = e && !Me(t, s.clsOpen)
              if (n || !e || s.collapsible || !(a.length < 2)) {
                ...
                t._wrapper ||
                  ((t._wrapper = we(i, '<div>')), it(t._wrapper, 'hidden', n ? '' : null)),
                  s._toggle(i, !0),
  ...
  function ri(r) {
    he(function () {
      ...
      Mt(
        ...
        function (t) {
          var e = t.target
          ;(He(e, 'animationName') || '').match(/^uk-.*(left|right)/) &&
            (i++,
            ...
            if ((e && e(), jt(t))) {
              ...
              e = Dt(document, re + ' ' + ae, function (t) {
                var e = Wt(t),
                  n = e.x,
                  i = e.y
                ;((o && n && 100 < Math.abs(r.x - n)) || (i && 100 < Math.abs(r.y - i))) &&
                  setTimeout(function () {
                    zt(o, 'swipe'),
                      zt(
                        o,
  ...
  var oi,
    ...
    ai = {
      ...
      update: {
        ...
        write: function (t) {
          ...
          !e || (this.inView && !n)
            ? this.player.pause()
            : (!0 === this.autoplay || (this.inView && n)) && this.player.play()
        },
        ...
        write: function (t) {
          ...
          r &&
            ...
            He(
              ...
              nt.cover(
                { width: r, height: o },
                { width: n + (n % 2 ? 1 : 0), height: e + (e % 2 ? 1 : 0) }
              )
            )
        },
        events: ['resize']
    ...
    ci = {
      ...
      data: { pos: 'bottom-' + (Zt ? 'right' : 'left'), flip: !0, offset: !1, clsPos: '' },
      computed: {
        pos: function (t) {
          var e = t.pos
      ...
      methods: {
        positionAt: function (t, e, n) {
          var i
          _e(t, this.clsPos + '-(top|bottom|left|right)(-[a-z]+)?'), He(t, { top: '', left: '' })
          var r = this.offset,
            o = this.getAxis()
          B(r) ||
            (r = (i = Se(r))
              ? en(i)['x' === o ? 'left' : 'top'] - en(e)['x' === o ? 'right' : 'bottom']
              : 0)
          var s = tn(
              t,
              e,
              'x' === o ? dn(this.dir) + ' ' + this.align : this.align + ' ' + dn(this.dir),
    ...
    ui = {
      ...
      connected: function () {
        ...
        ;(this.toggle =
          t && this.$create('toggle', at(t, this.$el), { target: this.$el, mode: this.mode })),
      ...
      events: [
        ...
        },
        {
          ...
          handler: function (t) {
            var e = t.target.hash
            e || t.preventDefault(), (e && Nt(e, this.$el)) || this.hide(!1)
          }
        },
        {
          name: 'beforescroll',
        ...
        },
        {
          ...
          handler: function (t, e) {
            jt(t) ||
              ...
              (t.preventDefault(), this.toggle && y(this.toggle.mode, 'hover') && this.hide())
          }
        },
        {
          name: 'beforeshow',
                ...
                ;(si = !0),
                  Mt(document, re, function (t) {
                    ...
                    if (!t.defaultPrevented)
                      for (
                        ;
                        oi && oi !== e && !Nt(n, oi.$el) && (!oi.toggle || !Nt(n, oi.toggle.$el));
          ...
          handler: function (t) {
            ...
            this.$el === e
              ? ((oi = this.isActive() ? null : oi),
                zt(this.$el, 'updatearia'),
                this.tracker.cancel())
              : (oi = null === oi && Nt(e, this.$el) && this.isToggled() ? this : oi)
          }
        },
        {
          name: 'updatearia',
          ...
          handler: function (t, e) {
            t.preventDefault(),
              ...
              (e || this.toggle) &&
                (it((e || this.toggle).$el, 'aria-expanded', this.isToggled() ? 'true' : 'false'),
      ...
      methods: {
        ...
        position: function () {
          ...
          if ('justify' === this.align) {
            ...
            this.$el.offsetWidth > Math.max(t.right - e.left, e.right - t.left) &&
    ...
    di = {
      ...
      computed: {
        ...
        target: function (t, e) {
          ...
          return (
            n &&
            ((!0 === n && this.input.parentNode === e && this.input.nextElementSibling) || at(n, e))
          )
        }
      },
      update: function () {
    ...
    for (var e = [[]], n = 0; n < t.length; n++) {
      ...
      if (r.height)
        for (var o = e.length - 1; 0 <= o; o--) {
          ...
          if (
            ((a =
              s[0].offsetParent === i.offsetParent ? gi(s[0]) : ((r = gi(i, !0)), gi(s[0], !0))),
  ...
  function gi(t, e) {
    ...
    var i = t.offsetTop,
      r = t.offsetLeft,
      o = t.offsetHeight
    return e && ((i = (n = gn(t))[0]), (r = n[1])), { top: i, left: r, height: o, bottom: i + o }
  }
  var vi = {
    extends: pi,
    mixins: [ti],
            ...
            ;(n = r.reduce(function (n, t, i) {
              return (
                (n[i] = t.map(function (t, e) {
                  return 0 === i
                    ? 0
                    : j(n[i - 1][e]) + (o - j(r[i - 1][e] && r[i - 1][e].offsetHeight))
                })),
            ...
            e.forEach(function (t, n) {
              return t.forEach(function (t, e) {
                return He(
                  ...
                  'transform',
                  i || r
                    ? 'translateY(' + ((r && -r[n][e]) + (i ? (e % 2 ? i : i / 8) : 0)) + 'px)'
                    : ''
                )
              })
            })
  ...
  var wi = Jt
            ...
            },
            {
              write: function () {
                ...
                this.elements.forEach(function (t) {
                  ...
                  e &&
                    (n.forceHeight ||
                      Math.round(e + hn('height', t, 'content-box')) >= t.offsetHeight) &&
                    He(t, 'height', e)
                })
              },
              order: 5,
    ...
    bi = {
      ...
      update: {
        read: function () {
          return { rows: (this.row ? mi(this.elements) : [this.elements]).map(yi) }
        },
        write: function (t) {
  ...
  function yi(t) {
    ...
    return (
      o && s && (He(t, 'minHeight', ''), (e = xi(t)), (i = e.heights), (r = e.max)),
      {
  ...
  var ki = {
    ...
    update: {
      read: function (t) {
        ...
        if (this.expand) {
          if (((this.$el.dataset.heightExpand = ''), Se('[data-height-expand]') !== this.$el))
            return !1
          ...
          !0 === this.offsetBottom
            ...
            : B(this.offsetBottom)
              ...
              : this.offsetBottom && u(this.offsetBottom, 'px')
                ...
                : D(this.offsetBottom) && (n += ' - ' + $i(at(this.offsetBottom, this.$el)) + 'px'),
            (n += (i ? ' - ' + i + 'px' : '') + ')')
        }
  ...
  var _i = {},
    ...
    zi = {
      ...
      computed: {
        icon: function (t, e) {
          var n = t.icon
          return Me(e, 'uk-search-icon') && kt(e, '.uk-search-large').length
            ? 'search-large'
  ...
  var Hi = {
    ...
    connected: function () {
      Ui[this.cacheKey]
        ? Li(this.$el, Ui[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes)
        : this.isImg &&
          this.width &&
          this.height &&
          Li(
            ...
            (function (t, e, n) {
              var i
              n &&
                ((i = nt.ratio({ width: t, height: e }, 'width', vn(ji(n)))),
                (t = i.width),
                (e = i.height))
              return (
    ...
    update: {
      read: function (t) {
        var e = this,
          n = t.image
        if (
          (n || 'complete' !== document.readyState || this.load(this.observer.takeRecords()),
          this.isImg)
        )
          return !1
        n &&
  ...
  function Li(t, e, n, i) {
    if (Yi(t)) i && (t.sizes = i), n && (t.srcset = n), e && (t.src = e)
      ...
      !y(t.style.backgroundImage, e) &&
        (He(t, 'backgroundImage', 'url(' + It(e) + ')'), zt(t, Bt('load', !1)))
    }
  }
      ...
      update: {
        ...
        write: function (t) {
          Oe(this.wrapper, this.clsHide, t.hide),
            t.changed &&
              ((t.changed = !1), it(this.wrapper, this.attrFill, new Array(t.width).join(t.fill)))
        },
        events: ['resize']
      }
    },
          ...
          handler: function (t) {
            ...
            ;(Gi = this),
              e
                ? this.stack
                  ? (this.prev = e)
                  : ((Gi = e).hide().then(this.show), t.preventDefault())
                : (function () {
                    if (Ji) return
                    Ji = [
                      Mt(document, re, function (t) {
  ...
  var nr = {
    install: function (a) {
      ;(a.modal.dialog = function (t, e) {
        var n = a.modal(
          ' <div class="uk-modal"> <div class="uk-modal-dialog">' + t + '</div> </div> ',
          e
        )
        return (
          n.show(),
  ...
  var ir = { extends: ni, data: { targets: '> .uk-parent', toggle: '> a', content: '> ul' } },
    rr = {
      mixins: [ti, wi],
      props: {
        dropdown: String,
      ...
      beforeConnect: function () {
        ...
        ;(this.dropbar =
          t && (at(t, this.$el) || Se('+ .uk-navbar-dropbar', this.$el) || Se('<div></div>'))),
          this.dropbar &&
        ...
        },
        {
          ...
          handler: function (t, e) {
            ...
            this.clsDrop && Ce(n, this.clsDrop + '-dropbar'),
              'bottom' === i &&
                this.transitionTo(
                  n.offsetHeight + j(He(n, 'marginTop')) + j(He(n, 'marginBottom')),
                  n
                )
          }
        },
      ...
      methods: {
        ...
        transitionTo: function (t, e) {
          var n = this,
            ...
            r = Et(i) ? on(i) : 0
          return (
            He((e = r < t && e), 'clip', 'rect(0,' + e.offsetWidth + 'px,' + r + 'px,0)'),
            on(i, r),
            Ue.cancel([e, i]),
            Rt.all([
              Ue.start(i, { height: t }, this.duration),
              Ue.start(e, { clip: 'rect(0,' + e.offsetWidth + 'px,' + t + 'px,0)' }, this.duration)
            ])
              .catch(Q)
              .then(function () {
        ...
        },
        {
          ...
          handler: function () {
            'reveal' !== this.mode ||
              ...
              (we(this.panel, '<div>'), Ce(this.panel.parentNode, this.clsMode)),
  ...
  var ar = {
      ...
      update: {
        ...
        write: function (t) {
          var e = t.current,
            n = t.max
          He(this.$el, 'maxHeight', n), Math.round(e) !== Math.round(n) && zt(this.$el, 'resize')
        },
        events: ['resize']
      }
    },
    ...
    cr = {
      ...
      methods: {
        scrollTo: function (e) {
          ...
          if ((t < r + i && (r = t - i), zt(this.$el, 'beforescroll', [this, e]))) {
            var o = Date.now(),
              ...
              a = function () {
                ...
                mn(window, t), t !== r ? requestAnimationFrame(a) : zt(n.$el, 'scrolled', [n, e])
              }
            a()
          }
        }
      ...
      events: {
        click: function (t) {
          t.defaultPrevented ||
            (t.preventDefault(), this.scrollTo(It(decodeURIComponent(this.$el.hash)).substr(1)))
        }
      }
    }
  var ur = {
      ...
      update: [
        {
          write: function () {
            this.hidden &&
              He(_t(this.elements, ':not(.' + this.inViewClass + ')'), 'visibility', 'hidden')
          }
        },
        {
          read: function (t) {
            ...
            t.update &&
              this.elements.forEach(function (t) {
                ...
                ;((e = e || { cls: st(t, 'uk-scrollspy-class') || n.cls }).show = fn(
                  t,
                  n.offsetTop,
                  n.offsetLeft
                )),
    ...
    dr = {
      ...
      computed: {
        ...
        isActive: {
          ...
          set: function (t) {
            t && !this.isActive
              ? (Ne(this.selTarget, this.clsInactive, this.clsActive), zt(this.$el, 'active'))
              : t ||
                Me(this.selTarget, this.clsInactive) ||
                (Ne(this.selTarget, this.clsActive, this.clsInactive), zt(this.$el, 'inactive'))
          }
        }
      },
      connected: function () {
      ...
      disconnected: function () {
        this.isFixed && (this.hide(), Ae(this.selTarget, this.clsInactive)),
          ve(this.placeholder),
              ...
              r &&
                xn.read(function () {
                  ...
                  i.isFixed &&
                    t <= e + n &&
                    e <= t + r.offsetHeight &&
                    mn(window, t - n - (B(i.targetOffset) ? i.targetOffset : 0) - i.offset)
                })
            }
          }
        }
      ...
      update: [
        {
          read: function (t, e) {
            ...
            return (
              (this.top = Math.max(j(fr('top', this)), this.topOffset) - this.offset),
              (this.bottom = i && i - n),
          ...
          write: function (t) {
            var e = t.height,
              ...
              i = this.placeholder
            He(i, X({ height: e }, n)),
              Nt(i, document) || (me(this.$el, i), it(i, 'hidden', '')),
          ...
          write: function (t, e) {
            ...
            if (
              !(
                ...
                ((300 < u - i || r !== o) && ((t.initScroll = a), (t.initTimestamp = u)),
                (t.lastDir = r),
              ...
              if (
                ...
                this.isFixed
                  ? this.update()
                  : this.animation
                    ? (Ze.cancel(this.$el), this.show(), Ze.in(this.$el, this.animation).catch(Q))
                    : this.show()
          },
          events: ['resize', 'scroll']
        }
      ...
      methods: {
        ...
        update: function () {
          ...
          this.bottom && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll),
            He(this.$el, { position: 'fixed', top: e + 'px', width: this.width }),
            (this.isActive = t),
          ...
          handler: function (t) {
            ...
            ;(xt(t.target, 'a[href="#"], a[href=""]') ||
              ((e = xt(t.target, 'a[href]')) &&
                (this.cls || !Et(this.target) || (e.hash && bt(this.target, e.hash))))) &&
              t.preventDefault(),
              this.toggle()
          }
        }
        ...
        animate: function (t) {
          ...
          var s = on(this.target),
            a = (r = r.concat(
              ...
              return (
                !!(t.parentNode && e in o) &&
                (o[e] ? (Et(t) ? Ir(t) : { opacity: 0 }) : { opacity: Et(t) ? 1 : 0 })
              )
            })
          return (
            ...
            Rt.all(
              r
                ...
                .concat(Ue.start(this.target, { height: s }, this.animation, 'ease'))
            ).then(function () {
              r.forEach(function (t, e) {
                return He(t, { display: 0 === a[e].opacity ? 'none' : '', zIndex: '' })
              }),
                $r(i.target),
                i.$update(i.target),
                xn.flush()
  ...
  function Ir(t) {
    var e = t.getBoundingClientRect(),
      ...
      o = r.top,
      s = r.left
    return { top: (o += j(He(t, 'marginTop'))), left: s, height: n, width: i }
  }
  var Sr = {
    mixins: [xr],
    args: 'target',
          ...
          if (n) {
            var r = (function (t, n, i) {
              return X([], t).sort(function (t, e) {
                return (
                  st(t, n).localeCompare(st(e, n), void 0, { numeric: !0 }) * ('asc' === i || -1)
                )
              })
            })(a, n, i)
            q(r, a) ||
      ...
      (r || H(s)) &&
        (o
          ? r
            ...
            : (delete n.filter[o], (P(n.filter) || '' in n.filter) && (n.filter = { '': r || '' }))
          : (n.filter = { '': r || '' })),
      H(s) || (n.sort = [s, a]),
      n
    )
  ...
  var Cr = {
    slide: {
      ...
      translate: function (t, e) {
        return [{ transform: _r(-100 * e * t) }, { transform: _r(100 * e * (1 - t)) }]
      }
    }
  }
  function Ar(t) {
      ...
      },
      {
        ...
        methods: {
          start: function () {
            ...
            var e = 'touchmove' != ie ? Mt(document, ie, this.move, { passive: !1 }) : Q
          ...
          move: function (t) {
            ...
            if (this.unbindMove) {
              ...
              if (
                ...
                ;[this.index, this.prevIndex]
                  ...
                  .forEach(function (t) {
                    zt(i[t], 'itemhidden', [e]), d && ((h = !0), (e.prevIndex = r))
                  }),
                  ...
                  l && (d || zt(c, 'itemhide', [this]), zt(u, 'itemshow', [this]))
              }
            }
          },
          end: function () {
            ...
            He(this.list, { userSelect: '', pointerEvents: '' }), (this.drag = this.percent = null)
          }
        }
      },
      {
            ...
            this.navItems.forEach(function (t) {
              ...
              Oe(t, n.clsActive, F(e) === i),
                Oe(
                  t,
                  'uk-invisible',
                  n.finite && (('previous' === e && 0 === i) || ('next' === e && i >= n.maxIndex))
                )
            })
          }
        }
        ...
        if ((void 0 === e && (e = !1), !this.dragging && this.length)) {
          ...
          if ((i[e ? 'unshift' : 'push'](t), !e && 1 < i.length))
            ...
            if (a !== c) {
              ...
              return a && zt(a, 'itemhide', [this]), zt(c, 'itemshow', [this]), u
            }
            o()
          }
        }
          ...
          return {
            ...
            show: function (t, e, n) {
              ...
              return (
                ...
                this.translate(e),
                Or(s, 'itemin', { percent: e, duration: t, timing: r, dir: a }),
                Or(o, 'itemout', { percent: 1 - e, duration: t, timing: r, dir: a }),
            ...
            translate: function (t) {
              ...
              He(s, e[1]),
                He(o, e[0]),
                Or(s, 'itemtranslatein', { percent: t, dir: a }),
                Or(o, 'itemtranslateout', { percent: 1 - t, dir: a })
            },
            percent: function () {
              return n(o || s, s, a)
            },
              ...
              if ('image' === n || e.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i))
                ...
                it(a, 'src', e),
                  Dt(a, 'error loadedmetadata', function (t) {
                    'error' === t
                      ? s.setError(r)
                      : (it(a, { width: a.videoWidth, height: a.videoHeight }), s.setItem(r, a))
                  })
                ...
                (o =
                  e.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/watch\?v=([^&\s]+)/) ||
                  e.match(/()youtu\.be\/(.*)/))
              ) {
                var h = o[2],
                  c = function (t, e) {
                    return (
                      ...
                      s.setItem(
                        r,
                        Hr(
                          'https://www.youtube' + (o[1] || '') + '.com/embed/' + h,
                          t,
                          e,
                          s.videoAutoplay
                        )
                ...
                Gt('https://img.youtube.com/vi/' + h + '/maxresdefault.jpg').then(function (t) {
                  var e = t.width,
                    n = t.height
                  120 === e && 90 === n
                    ? Gt('https://img.youtube.com/vi/' + h + '/0.jpg').then(function (t) {
                        var e = t.width,
                          n = t.height
                        return c(e, n)
                      }, c)
                ...
                (o = e.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) &&
                  Kt('https://vimeo.com/api/oembed.json?maxwidth=1920&url=' + encodeURI(e), {
                    responseType: 'json',
                    withCredentials: !1
                  }).then(
                    function (t) {
                      ...
                      return s.setItem(
                        r,
                        Hr('https://player.vimeo.com/video/' + o[2], i, n, s.videoAutoplay)
                      )
                    },
                    function () {
                      return s.setError(r)
      ...
      methods: {
        show: function (t) {
          ...
          return (
            (this.panel =
              this.panel ||
              this.$create('lightboxPanel', X({}, this.$props, { items: this.items }))),
            ...
            function (t, e) {
              ...
              switch (e) {
                ...
                case 'y':
                  ;(r = r || 'px'),
                    (t.transform +=
                      ' translate' + p(e) + '(' + j(s).toFixed('px' === r ? 0 : 2) + r + ')')
                  break
                case 'rotate':
  ...
  var no = {
          ...
          return {
            ...
            show: function (t, e, n) {
              ...
              return (
                ...
                (e = r ? e : Z(e, 0, 1)),
                to(this.getItemIn(), 'itemin', { percent: e, duration: t, timing: i, dir: o }),
                r &&
                ...
                Ue.start(a, { transform: _r(-c * (Zt ? -1 : 1), 'px') }, t, i).then(h.resolve, Q),
                h.promise
              )
            },
            stop: function () {
            ...
            translate: function (t) {
              ...
              He(a, 'transform', _r(Z(e - e * t - c, -Jr(a), Qr(a).width) * (Zt ? -1 : 1), 'px')),
                ...
                r &&
                  ((t = Z(t, -1, 1)),
                  to(this.getItemIn(), 'itemtranslatein', { percent: t, dir: o }),
                  to(this.getItemIn(!0), 'itemtranslateout', { percent: 1 - t, dir: o }))
            },
            percent: function () {
                ...
                this.slides.reduce(function (t, e, n) {
                  ...
                  if (a < c + i && (!o.center && n > o.maxIndex && (n = o.maxIndex), !y(t, n))) {
                    ...
                    o.center && r && i < h - Qr(r).width / 2
                      ? (h -= i)
                      : ((h = s), t.push(n), (a = c + s + (o.center ? i / 2 : 0)))
                  }
                  return (c += i), t
                }, []))
            ) && e
      ...
      update: {
        write: function () {
          var n = this
          Te('[' + this.attrItem + '],[data-' + this.attrItem + ']', this.$el).forEach(
            function (t) {
              var e = st(t, n.attrItem)
              n.maxIndex &&
                Oe(t, 'uk-hidden', B(e) && ((n.sets && !y(n.sets, j(e))) || e > n.maxIndex))
            }
          ),
        ...
        reorder: function () {
          ...
          if ((He(this.slides, 'order', ''), !this.finite)) {
            ...
            if (
              ...
              for (
                var t = this.slides[i], e = Qr(this.list).width / 2 - Qr(t).width / 2, r = 0;
                0 < e;
        ...
        },
        {
          ...
          handler: function (t) {
            ...
            Ue.cancel(this.$el),
              ...
              Ue.start(this.$el, this.getCss(ro(e) ? 0.5 : 0 < s ? 1 : 0), r, o).catch(Q)
          }
        },
        {
  ...
  var so,
    ao = X({}, Cr, {
      ...
      scale: {
        show: function () {
          return [{ opacity: 0, transform: Nr(1.5), zIndex: 0 }, { zIndex: -1 }]
        },
        percent: function (t) {
          return 1 - He(t, 'opacity')
        },
        translate: function (t) {
          return [{ opacity: 1 - t, transform: Nr(1 + 0.5 * t), zIndex: 0 }, { zIndex: -1 }]
        }
      },
      pull: {
        show: function (t) {
    ...
    co = {
      ...
      update: {
        write: function () {
          if (
            (this.clsEmpty && Oe(this.$el, this.clsEmpty, P(this.$el.children)),
      ...
      methods: {
        init: function (t) {
          ...
          !r ||
            ...
            (this.touched = [this]),
            (this.placeholder = r),
            (this.origin = X({ target: e, index: ce(r) }, this.pos)),
        ...
        remove: function (t) {
          Nt(t, this.$el) &&
            (He(this.handle ? Te(this.handle, t) : t, { touchAction: '', userSelect: '' }),
            this.animation
  ...
  var po,
    ...
    wo = {
      ...
      beforeConnect: function () {
        ;(this._hasTitle = rt(this.$el, 'title')), it(this.$el, { title: '', 'aria-expanded': !1 })
      },
      disconnected: function () {
        this.hide(),
          it(this.$el, { title: this._hasTitle ? this.title : null, 'aria-expanded': null })
      },
      methods: {
        show: function () {
          var e = this
  ...
  function $o(t) {
    ...
    ;('attributes' !== t.type
      ? (function (t) {
          for (var e = t.addedNodes, n = t.removedNodes, i = 0; i < e.length; i++) Io(e[i], mo)
