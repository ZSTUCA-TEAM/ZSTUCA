  ...
  function t(e) {
    ;(e +=
      ...
      $('.post-content').on('copy', function (a) {
        ;(window.clipboardData || a.originalEvent.clipboardData).setData('text/plain', e),
          a.preventDefault()
      })
  }
  if (
    ...
    $(document).scroll(function () {
      ...
      e > s
        ? (e > 3 * s && o.addClass('headerUp'),
          ...
          c.css('color', '#666'),
          $('.g-nav').addClass('nav-' + i))
        : (o.removeClass('headerUp'),
          o.css({ 'background-color': 'transparent', 'box-shadow': 'none' }),
          r.css({
            background: 'url(/assets/icons/logo.svg) no-repeat center',
            'background-size': '100% 100%'
          }),
          c.css('color', '#fff'),
          $('.g-nav').removeClass('nav-' + i)),
        l > e ? o.addClass('headerDown') : o.removeClass('headerDown'),
        (l = e)
    })
  }
  $('.read-next-item section').each(function () {
    ...
    (function () {
      for (
        ...
        o > 0 && 1 !== o
          ? (t += '<a href="' + n + o + '" class="page-link page-num">' + o + '</a>')
          : 1 === o && (t += '<a href="' + n + '" class="page-link page-num">' + o + '</a>')
      t += '<span class="page-link page-num active">' + a + '</span>'
      for (var s = a + 1; s <= a + 3; s++)
        s <= e && (t += '<a href="' + n + s + '" class="page-link page-num">' + s + '</a>')
        ...
        $.getJSON('../../search.json').done(function (a) {
          ...
          for (var t in a) {
            ...
            '' !== e &&
              ...
              (n += '<a class="search_item" href="' + o.url + '">' + o.title + '</a>')
          }
